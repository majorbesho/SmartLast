! function() {
    ...
    function F(t, n, i, e, o, a, s) {
        this.v = t, this.B = n, this.c = i, this.a = e, this.s = s || "BESbswy", this.f = {}, this.w = o || 3e3, this.u = a || null, this.o = this.j = this.h = this.g = null, this.g = new N(this.c, this.s), this.h = new N(this.c, this.s), this.j = new N(this.c, this.s), this.o = new N(this.c, this.s), t = E(t = new y(this.a.c + ",serif", x(this.a))), this.g.a.style.cssText = t, t = E(t = new y(this.a.c + ",sans-serif", x(this.a))), this.h.a.style.cssText = t, t = E(t = new y("serif", x(this.a))), this.j.a.style.cssText = t, t = E(t = new y("sans-serif", x(this.a))), this.o.a.style.cssText = t, A(this.g), A(this.h), A(this.j), A(this.o)
    }
            ...
            if (0 === e.length && s) T(n.a);
                ...
                for (f = 0; f < e.length; f++) {
                    var l = e[f],
                        ...
                        p = n.a,
                        d = l;
                    p.g && c(p.f, [p.a.c("wf", d.c, x(d).toString(), "loading")]), S(p, "fontloading", d), p = null, null === q && (q = !!window.FontFace && (!(d = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) || 42 < parseInt(d[1], 10))), p = q ? new W(i(n.g, n), i(n.h, n), n.c, l, n.s, u) : new F(i(n.g, n), i(n.h, n), n.c, l, n.s, t, u), h.push(p)
                }
                        ...
                        for (var r, f = (r = r.split(",")).length, c = 0; c < f; c++) {
                            ...
                            if ((h = r[c]).match(/^[\w-]+$/))
                                if (null == (u = Y.exec(h.toLowerCase()))) h = "";
                                    ...
                                    if (h = null == (h = u[2]) || "" == h ? "n" : X[h], null == (u = u[1]) || "" == u) u = "4";
                                    else var l = V[u],
