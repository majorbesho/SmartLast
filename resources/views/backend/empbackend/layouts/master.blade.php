...
<div class="wrapper">
  ...
  <!-- Navbar backend.empbackend.layouts.master -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
   @include('backend.empbackend.layouts.nav')
  </nav>
  <!-- /.navbar -->

  <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    @include('backend.empbackend.layouts.saidbar')
  </aside>

  @yield('content')
  <!-- /.content-wrapper -->
  @include('backend.empbackend.layouts.footer')
