        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form id="quickForm" action="{{route('project.update',$project->id)}}" method="POST">
                @csrf
                @method('patch')
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter company" value="{{$project->company}}">
                  </div>
                    ...
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter type" value="{{$project->type}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter youtubeurl" value="{{$project->youtubeurl}}">
                  </div>
                  ...
                  <div id="holder" style="margin-top:15px;max-height:100px;" value="{{$project->photo}}"></div>
