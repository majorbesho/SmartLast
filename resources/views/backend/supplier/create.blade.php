          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Suppliers  <small>Add New Suppliers  </small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="col-12">
              ...
              <form id="quickForm" action="{{route('supplier.store')}}" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    placeholder="Enter Start date" value="{{old('contactNo')}}">
                  </div>
                  <div class="form-group">
                    ...
                    name="resName"
                    class="form-control" id=""
                    placeholder="Enter resName" value="{{old('resName')}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    class="form-control" id=""
                    placeholder="Enter tele" value="{{old('tele')}}">
                  </div>
                  <div class="form-group">
                    <label for="">web</label>
                    <input type="url" name="web"
                    class="form-control" id=""
                    placeholder="Enter web" value="{{old('web')}}">
                  </div>
                  <div class="form-group">
