...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="affiliate-single-wrapper pt-120 pb-120">
                        <div class="affiliate-single-wrapper__obj"><img src="{{asset('frontend4/assets/images/elements/affiliate-obj.png')}}" alt="image"></div>
        ...
        <div class="container">
            ...
            <div class="row mb-none-30 justify-content-center">
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="work-card text-center">
                        <div class="work-card__icon">
                            <div class="inner"><img src="{{asset('frontend4/assets/images/icon/how-work/1.png')}}" alt="image"></div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="work-card text-center">
                        <div class="work-card__icon">
                            <div class="inner"><img src="{{asset('frontend4/assets/images/icon/how-work/2.png')}}" alt="image"></div>
                        </div>
                        <div class="work-card__content">
                ...
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="work-card text-center">
                        <div class="work-card__icon">
                            <div class="inner"><img src="{{asset('frontend4/assets/images/icon/how-work/3.png')}}" alt="image"></div>
                        </div>
                        <div class="work-card__content">
    ...
    <section class="pt-120 pb-120 position-relative">
        <div class="bg-el"><img src="{{asset('frontend4/assets/images/elements/affiliate-bg.jpg')}}" alt="image"></div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-header text-center">
