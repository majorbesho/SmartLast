 ...
 overflow: inherit;
    ...
    <section class="hero">
        ...
        <div class="hero__element">
         <img src="{{ asset('frontend4/assets/images/home-bg.png') }}" alt="image">
        </div>
        @if (count($banner) > 0)
                        ...
                        <div class="col-lg-6">
                            <div class="wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="1s">
                                <div class="videoyoutube" >
                                    <iframe style="border-radius: 25px; box-shadow: rgba(0, 0, 0, 0.25) 0 5px 15px 0; height: 415px; width: 100%;" class="hero-car"
                                        src="{{ $banersingle->name }}" style="height: 400px;width: 600px;" >
                                    </iframe>
                                </div>
                            </div>
    ...
    <section>
        <div class="container pt-5 pb-5">
            <div class="row">
                <div class="col-lg-12 newimg">
                    <a href="https://www.smartboxuae.ae/user/box/electronics-box">

                    <img src="{{asset('frontend4/assets/images/home-header.jpeg')}}" alt="" srcset=""  style="border-radius: 25px;">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container pb-5 pt-5">
            <div class="row">
                <div class="col-12 newimg">
                    <img src="{{ asset('frontend4/assets/images/942.jpg') }}" alt="SmartBox" srcset=""
                                ...
                                @if (count($box) > 0)
                                    @foreach ($box as $boxoneNext)
                                        <div class="col-xl-3 col-md-6 mb-30" style="margin-bottom:6%;">
                                            <div class="contest-card zoom {{ $loop->first ? 'launched' : '' }} {{ $loop->index == 1 ? 'closing' : '' }}">
                                                @if ($loop->index == 1)
                            ...
                            @if (count($box) > 0)
                                @foreach ($box as $boxoneNext)
                                    <div class="row mt-5 campaignCard zoom">
                                        ...
                                        <div class="col-md-6">
                                            <img src="{{asset('frontend4/assets/images/win1.png')}}" alt="" style="width: 10%;">
            ...
            <div class="row mt-5 mb-5">
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="img-container2">
                        <img class="contactImg" src="{{ asset('frontend4/images/icon2-lite.png') }}" alt="icon2" srcset="">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="img-container2">
                        <img class="faqImg" src="{{ asset('frontend4/images/icon3-lite.png') }}" alt="icon3" srcset="">
