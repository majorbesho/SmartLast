                ...
                <table role="presentation"
                    ...
                    <tr>
                        ...
                        background-image: -ms-linear-gradient(7deg, rgb(101 44 96) 0%, rgb(29 23 96) 50%, rgb(46 135 180) 100%);line-height: 77px;box-shadow: 0 5px 15px 0 rgba(0, 0, 0, 0.25);">
                            <img src="https://smartboxuae.ae/frontend4/images/color-logo.png" alt="" width="300"
                    ...
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">
                                            Order Confirmation From SmartBox</h1> <br>
                                            Dear {{$details['user_name']}},

                                        <p
                                            style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                            Thank you for your purchase of the {{$details['total_amount']}} AED Voucher No. {{$details['order_number']}} .
                                        ...
                                        <p
                                            ...
                                            <a href="https://smartboxuae.ae/"
                                                style="color:#ee4c50;text-decoration:underline;">https://smartboxuae.ae</a></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:0;">
                        ...
                        @if (\Gloudemans\Shoppingcart\Facades\Cart::instance('shopping')->count() > 0)
                            ...
                            <tr id="customers">
                                ...
                                <img src="{{$photos[0]}}" alt="" srcset=""  style="width: 99px;padding-left: 7%;"/>
                                </td>
                                <td  >{{$item->name}}</td>
                                <td  >{{$item->qty}}</td>
                                ...
                                <tr>
                                    <td style="padding:0;width:50%;" align="left">
                                        <p
                                            ...
                                            &reg; https://smartboxuae.ae 2023<br /><a href="https://smartboxuae.ae/"
                                        ...
                                        <table role="presentation"
                                            ...
                                            <tr>
                                                <td style="padding:0 0 0 10px;width:38px;">
                                                    <a href="https://www.instagram.com/smartboxuae/" style="color:#ffffff;">
                                                ...
                                                <td style="padding:0 0 0 10px;width:38px;">
                                                    <a href="https://www.facebook.com/profile.php?id=100092493111750" style="color:#ffffff;">
                                                ...
                                                <td style="padding:0 0 0 10px;width:38px;">
                                                    <a href="https://www.youtube.com/@smartboxuae/" style="color:#ffffff;">
