                                    ...
                                    @foreach ($box as $boxone)
                                        @if ($loop->first)
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <h2 class="contest-wrapper__title"> </h2>
                                                        <h4 class="contest-wrapper__title">Weekly Box </h4>

                                                        <p>
                                                        <div class="wrap-countdown center mercado-countdown"
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <img src="{{ $boxone->photo }}" alt="{{ $boxone->title }}"
                                                            srcset=""
                                                            style="width: 350px;height: 200px;padding-bottom: 1%;">
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                                    ...
                                                    <div class="tp-shop-main-wrapper">
                                                        <div class="tp-shop-top mb-45">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                                    <div
                                                                        class="tp-shop-top-left d-flex align-items-center ">
                                                                        <div class="tp-shop-top-tab tp-tab">
                                                                            <ul class="nav nav-tabs" id="productTab"
                                                                                ...
                                                                                <li class="nav-item" role="presentation">
                                                                                    <button class="nav-link" id="list-tab"
                                                                                        data-bs-toggle="tab"
                                                        ...
                                                        <div class="tp-shop-items-wrapper tp-shop-item-primary">
                                                            <div class="tab-content" id="productTabContent">
                                                                ...
                                                                <div class="" id="grid-tab-pane" role="tabpanel"
                                                                    aria-labelledby="grid-tab" tabindex="0">
                                                                    <div class="row">
                                                                        @if (count($gop) > 0)
                                                                            @foreach ($gop as $itemxx)
                                                                                <div
                                                                                    ...
                                                                                    <div class="tp-product-item-2 mb-40">
                                                                                        <div
                                                                                            ...
                                                                                            <a
                                                                                                href="{{ route('groupOfProduct', $itemxx->slug) }}">
                                                                                                <img src="{{ $itemxx->photo }}"
                                                                                                    alt="{{ $itemxx->title }}"
                                                                                                    style="width: 350px;">
                                                                                            </a>
                                                                                            <!-- product action -->
                                                                                        ...
                                                                                        <div
                                                                                            class="tp-product-content-2 pt-15">
                                                                    ...
                                                                    <a href="#">Wonder</a> --}}
                                                                                            ...
                                                                                            <h3 class="tp-product-title-2">
                                                                                                <a
                                                                                                    href="{{ route('groupOfProduct', $itemxx->slug) }}">{{ $itemxx->title }}</a>
                                                                                            </h3>
                                                                                            <div
                                                                                            ...
                                                                                            <div
                                                                                                class="tp-product-price-wrapper-2">
                                                                                                <span
                                                                                                    class="tp-product-price-2 new-price">{{ $itemxx->showprice }}</span>
                                                                                                <span
                                                                                                    class="tp-product-price-2 old-price">{{ $itemxx->price }}</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
