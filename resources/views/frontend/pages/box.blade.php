                    ...
                    <div class="cart-wrapper">
                        <div class="row justify-content-lg-between">
                            ...
                            <div class="col-lg-8">
                                ...
                                <!--        <p style="color: #000;">Closing at </p>-->
                                ...
                                <div class="contest-cart__thumb-slider">
                                    ...
                                    @foreach ($photos as $key => $photo)
                                        ...
                                        {{-- {{$key==0 ? active : ''}} <img src="{{$photo[0]}}" alt="image"> --}}
                                    @endforeach
                                </div>
                                <div class="contest-cart__nav-slider">
                                    ...
                                    @foreach ($photosx as $key => $photosx)
                                        <div class="single-slide">
                                            ...
                                            style="border-radius: 25px; height: 80%;"> --}}
                                        </div>
                                    @endforeach
                                            ...
                                            <div class=" flex-wrap align-items-center mb-30">
                                                    ...
                                                    {{-- <form>
                                                        <div class="quantity-nav">
                                                            ...
                                                            <input type="text" name="name" value="0"
                                                                onchange="if(this.value<0){this.value=0}" id="innum" />

                                                            <div class="quantity-button quantity-down">
                                                                <i class="las la-minus"></i>
                                                                <input type="button" value="up"
                                                                    onclick="if(this.form.name.value>=0){this.form.name.value++;}">
                                                            </div>
                                                ...
                                                {{-- <div class="mt-sm-0 mt-3 click-to-buy2" style="padding-top: 4%;">
                                                    <a href="{{ route('stripe.get.v') }}" data-quantity="1"
                                                        ...
                                                        class="add_to_cart cmn-btn style--three" style="width: 100%;">Buy Now</a>
                                                    {{--  cmn-btn style--three
                                                </div> --}}
                                            </div>
                                ...
                                <ul class="nav nav-tabs justify-content-center mb-30 pb-4 border-0" id="myTab"
                                    ...
                                    {{-- <li class="nav-item" role="presentation">
                                        <button class="cmn-btn active" id="description-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="true"><span class="mr-3"></span> description</button>
                                    </li> --}}
                                    {{-- <li class="nav-item" role="presentation">
                                        <button class="cmn-btn" id="details-tab" data-bs-toggle="tab"
                                            data-bs-target="#details" role="tab" aria-controls="details"
                                            aria-selected="false"><span class="mr-3"></span>competition details</button>
                                    </li> --}}
                                </ul>
...
<section>
    <input type="checkbox" name="chk" id=""> i accept terms and asdaaa
</section>
                ...
                success: function(data) {
                    ...
                    if (data['status']) {
                        swal({
                            ...
                            // title: 'Go <input type="checkbox" name="chk" id=""> i accept terms and asdaaa  b!',
                            text: data['message'],
                            icon: "success",
                            button: "Aww yiss!",
                        });
