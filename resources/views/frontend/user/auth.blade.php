                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-md-6">
                                                        <button type="submit" class="btn btn-primary gr-btn"
                                ...
                                <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel"
                                    ...
                                    <div class="row mb-none-30">
                                        <form method="POST" action="{{ route('register.submit') }}" class="">
                                            @csrf
                                            <div class="container "
                                                style="border-radius: 25px;display: flex;flex-wrap: wrap;flex-direction: column;justify-content: center;">
                                                ...
                                                <div class="row">
                                                    <div class="">
                                                        <div class="content">
                                                            ...
                                                            <div class="row mb-3  pt-10 d-none">
                                                                <input type="date" name="dateOfbarth" id=""
                                                            ...
                                                            <div class="row mb-3 pt-10">
                                                                <select class="form-control form-select"
                                                                    ...
                                                                    data-placeholder="nationality" name="nationality"
                                                                    required>
