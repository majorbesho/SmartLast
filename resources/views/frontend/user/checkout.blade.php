                                ...
                                <div class="col-lg-7" >
                                    <div class="checkout-form-area">
                                        ...
                                        @csrf --}}
                                            ...
                                            <h5 class="payment-form__title" style="color: #000">Enter Your Card Details </h5>
                                            <div class="form-row">
                                        ...
                                        <div class="checkout-wrapper__body">
                                            <ul class="price">
                                                @foreach (\Gloudemans\Shoppingcart\Facades\Cart::instance('shopping')->content() as $item)
                                                    <li>
                                                        ...
                                                        <div class="right">
                                                            <span class="price" style="color: #000">{{ $item->price }} </span>
                                                        </div>
                                                    </li>
                                                @endforeach
                                                <li>
                                                    ...
                                                    <div class="right">
                                                        <span class="price" style="color: #000"> {{ Cart::subtotal() }} </span>
                                                        <input type="hidden"
                                                            value="{{ (float) str_replace(',', '', Cart::subtotal()) }}"
                                                            name="total">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 loginecheck d-flex align-items-end flex-column bd-highlight mb-3">
                                                        ...
                                                        <div class="form-group col-lg-12">
                                                            <input type="password" placeholder="Enter your password Number"
                                                                name="password" >
                                                        </div>
                                                        <button type="submit" class=" mt-auto p-2 bd-highlight btn btn-success">Login  </button>
                                                    </form>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <form action="{{route('register.submit')}}" method="get">
                                                            ...
                                                            <div class="form-group col-lg-12">
                                                                <input type="confirm-password" placeholder="Enter your password Number"
