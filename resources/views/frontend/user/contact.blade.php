                                        ...
                                        <div class="contact-info-wrapper">
                                            <div class="d-flex flex-wrap justify-content-between w-100">
                                                <div class="contact-info">
                                                    <div class="contact-info__icon"><img src="{{asset('frontend2/assets/images/icon/contact/1.png')}}" alt="image"></div>
                                                ...
                                                <!-- contact-info end -->
                                                <div class="contact-info">
                                                    <div class="contact-info__icon"><img src="{{asset('frontend2/assets/images/icon/contact/2.png')}}" alt="image"></div>
                                                    <div class="contact-info__content">
                                                        <p>Email</p>
                                                        {{-- <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0960676f66497b606f68276a6664">[email&#160;protected]</a></span>
                                                        <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0960676f66497b606f68276a6664">[email&#160;protected]</a></span> --}}
                                                    </div>
                                                </div>
                                                <!-- contact-info end -->
                                            </div>
                                            <div class="contact-thumb"><img src="{{asset('frontend2/assets/images/elements/contact.png')}}" alt="image"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
