                                                    ...
                                                    <div class="row">
                                                        @for ($i = 0; $i < $item->qty; $i++)
                                                            ...
                                                            <div class="col-lg-8 vcart">
                                                                ...
                                                                @if ($item->showPrice == 50 || $item->showPrice < 70)
                                                                <div class="leftv">
                                                                    <p> Name: <span style="color:#fff"  >{{ $item->name }}</span></p>
                                                                    <p> Box: <span style="color:#fff" > {{ $item->title }}</span></p>
                                                                    <p> Price: <span style="color:#fff" > {{ $item->showPrice }}</span></p>
                                                                    <p> Draw Date: <span style="color:#fff" >{{ $item->edate }} </span></p>
                                                                    <p> Exp Date: <span style="color:#fff" >{{ \Carbon\Carbon::parse($item->edate)->addDay(30) }}
                                                                        </span></p>
                                                                    <p> Supplier:<span style="color:#fff">{{ $item->supplier }} </span></p>
                                                                </div>
                                                                @else
                                                                <div class="leftv">
